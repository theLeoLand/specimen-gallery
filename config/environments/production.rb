...
Rails.application.configure do
  ...
  # Use memory cache (simpler than Solid Cache for now)
  config.cache_store = :memory_store

  # Use async job processing (runs in-memory, no database tables needed)
  # This processes jobs immediately without needing Solid Queue tables
